...
!!! info "Expectation"
    ...
    *Contributes fully, in a wider departmental role, to improving student attainment across the whole school, cascading information beyond the department*
    ...
    ??? abstract "Contributed to the committee on updating department handbooks"
        [![Handbooks](./Assets/Handbook%20template.png){align="right" style="height:230px;"}](https://kelletthk-my.sharepoint.com/:w:/r/personal/hchan_kellettschool_com/Documents/2022-2023/AH%20docs/Working%20Parties/Department%20Handbook%20Template%20-%20To%20be%20copied.docx?d=wb26679f7b324411b94758f32dc489283&csf=1&web=1&e=I0Gxvi)
    ...
    ??? abstract "Led training on technology use in the school"
        [![Tech training](./Assets/iPad%20training.png){width="35.5%"}](https://docs.google.com/presentation/d/134mDaJS83Bx6Gm-cRcV5173w9sE6nF2i6ASt-VBKjxM/edit?usp=sharing)
    ...
    ??? abstract "Led training on Artificial Intelligence for feedback, marking and assessment CPD group"
        [![AI CPD](./Assets/Poe%20video.png){width="30%" align="right" style="clear: right;"}](https://www.youtube.com/watch?v=1wpIm4et-h0)
    ...
    ??? abstract "Led a 'Fireside Friday' on Artificial Intelligence"
        [![AI Fireside](./Assets/ChatGPTv2Slides.png){width="30%" align="left" style="clear: left;"}](./Assets/chatGPT_v02.pdf)
        [![AI Fireside](./Assets/Chinese%20to%20English%20bot.png){width="30%" align="left" style="clear: left;"}](https://poe.com/ChineseToEnglishKS)
    ...
    ??? abstract "Led a 'Fireside Friday' on Artificial Intelligence and voice transcription for feedback"
        [![AI transcription Fireside](./Assets/Otter%20transcription.png){width="30%" align="right" style="clear: right;"}](https://otter.ai/u/WLpapY6tmb-0mKeH-W1Jedzl9sk?utm_source=copy_url)
    ...
    ??? abstract "Innovation encourages skills development that are not subject or department specific, we are beginning to see the fruits of this labour in students in Y10 who have already experienced a few years of innovation."
        ![Innovation Greenhouse shelves](./Assets/GreenhouseBuldingShelves.png){width="30%" align="left" style="clear: left;"}
...
!!! info "Expectation"
    *Goes above and beyond in their contribution to the wider school community and with their extra-curricular commitment.*
    ...
    ??? abstract "Host the Blender ECA for all three terms"
        [![Blender ECA](./Assets/Blender.png){width="30%" align="right" style="clear: right;"}](https://www.blender.org/)
    ...
    ??? abstract "Conducted two catch up classes for Y11s and Y13s "
    ...
    ??? abstract "Flying and programming drones lesson with Outreach students"
        ![Drones in sports hall](./Assets/Drones%20sports%20hall.jpg){width="30%" align="right" style="clear: right;"}
    ...
    ??? abstract "Flying and programming drones lesson with year 6 students during science week (2 years in a row)"
        ![Science Week Drones](./Assets/MDaviesDronesY6.jpg){width="30%" align="left" style="clear: left;"}
    ...
    ??? abstract "3D animation in blender lesson with Outreach students"
        [![Blender](./Assets/Blender.png){width="30%" align="right" style="clear: right;"}](https://www.blender.org/)
    ...
    ??? abstract "Programming lesson with Outreach students"
        ![Spyrographs](./Assets/TurtleSpyrographs.png){width="40%" align="left" style="clear: left;"}
...
!!! info "Expectation"
    *A commitment to ongoing Continuous Professional Development (CPD)*
    ...
    ??? abstract "Attended PyCon Python Conference with Chris Hall"
        [![PyCon](./Assets/Pycon2023.JPG){width="30%" align="left" style="clear: left;"}](https://pycon.hk/2023/2023-schedule/)
    ...
    ??? abstract "Attended Design Technology Health and Safety Training"
        ![DT Training](./Assets/DTHnSTraining.jpeg){width="30%" align="right" style="clear: right;"}
    ...
    ??? abstract "Led a CPD for Computer Science teachers based in international schools in HK (CodeEd)"
        ![Martin Davies](./Assets/CodeEd%20Attendees.jpg){width="30%" align="left" style="clear: left;"}
...
!!! info "Expectation"
    *Training & Research*
    ...
    ??? abstract "Development of Curriculum surrounding AI (Innovation)"
        ![Martin Davies](./Assets/AIInnovationProjects.png){width="30%" align="right" style="clear: right;"}
    ...
    ??? abstract "Development of the KS3 Innovation curriculum"
        ![Martin Davies](./Assets/greenhouse%20pres.png){width="30%" align="right" style="clear: right;"}
    ...
    ??? abstract "Start of Innovation/Oceanography KS4 (6 Students, 9 for next academic year)"
        ![Innovation KS4](./Assets/InnovationKS4MiniProj.png){width="30%" align="left" style="clear: left;"}
    ...
    ??? abstract "Developed this portfolio using mkdocs and markdown notation (consider viability for students to use in Innovation/CS)"
        ![Martin Davies](./Assets/mkdocs%20portfolio.png){width="30%" align="right" style="clear: right;"}
...
!!! info "Expectation"
    *Being part of the Conversation: Engages in Educational Debates.*
    ...
    ??? abstract "Active and vocal participant in CodeHers event and external group (9 international school initiative to get more females into Coding)"
        [![CodeHers](./Assets/CodeHers.jpeg){width="30%" align="right" style="clear: right;"}](https://codehershk.org/)
...
!!! info "Expectation"
    *Effectively uses IT in teaching and for professional purposes.*
    ...
    ??? abstract "Teach Computer Science"
        ![Martin Davies](./Assets/CSAlgorithmRobots.png){width="30%" align="right" style="clear: right;"}
...
!!! info "Expectation"
    *Effectively uses IT for departmental/Kellett marketing purposes.*
    ...
    ??? abstract "Marketing for CodeEd event"
        ![CodeEd Letter](./Assets/CodeEd%20Invite%20Letter.png){width="30%" align="right" style="clear: right;"}
    ...
    ??? abstract "Innovation and Coding featured on KS Instagram on several occasions"
        [![Martin Davies](./Assets/Innovation%20Insta.jpeg){width="30%" align="right" style="clear: right;"}](https://www.instagram.com/kellettschool/?hl=en)
...
!!! info "Expectation"
    *Shows leadership in teaching and learning.*
    ...
    ??? abstract "Led multiple fireside Friday events and staff training events as a part of CPD"
        ![Martin Davies](./Assets/ChatGPTv2Slides.png){width="30%" align="right" style="clear: right;"}
    ...
    ??? abstract "Positively reviewed by subordinates via 360 leadership review"
        [![Martin Davies](./Assets/LM360.png){width="30%" align="left" style="clear: left;"}](./Assets/Results%20-%20Leadership%20Matters.pdf)
